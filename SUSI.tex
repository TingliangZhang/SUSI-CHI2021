...
The main PCB schemetic is shown in Fig~\ref{PCBsch1} and its layout is shown in Fig~\ref{PCB1}.

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{PCBsch1.png}
  \caption{The main PCB schemetic}
  \label{PCBsch1}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\linewidth]{PCB1.png}
...
NTAG 5 boost should be used for antennas smaller or equal class 6. For larger antennas NTAG 5 link or switch should be used. So in this case, we use NXP NFC Antenna Design Tool to design a class 6 antenna for NTAG 5 boost. The antenna of a “Class 6” design shall be located within a zone defined by a circle of 25mm diameter.

The NFC PCB schemetic is shown in Fig~\ref{PCBsch2} and its layout is shown in Fig~\ref{PCB2}.

\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\linewidth]{PCBsch2.png}
  \caption{NFC-PCB schemetic}
  \label{PCBsch2}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\linewidth]{PCB2.png}
...
We will find some people who suffer from mood disorders and do some user experiences and field survey. Due to COVID pandamic, we have difficulty in UEX. But one of us suffers bipolar disorder, and she come up with this idea. Another member has major depressive disorder, he trys most functionality of SUSI GENE, and give mostly positive feedback.
