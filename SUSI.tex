...
The main PCB schemetic is shown in Fig~\ref{PCBsch1} and the PCB layout is shown in Fig~\ref{PCB1}.

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{PCBsch1.png}
  \caption{PCB schemetic}
  \label{PCBsch1}
\end{figure}
